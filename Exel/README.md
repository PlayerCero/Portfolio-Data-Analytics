...
| **2. PREDICIONES Y PREVISIONES** | **Analítica Predictiva.** Fundamental para Planeamiento de la Producción (PCP) y Finanzas.<br><br><img src="IMAGENES/Predicciones y previciones.jpg" alt="Análisis Predictivo de Unidades" width="300"> | Aplicación de **Suavizamiento Exponencial (ETS)** y Regresión Lineal sobre series de tiempo para proyectar unidades futuras con intervalos de confianza visualizados, permitiendo gestionar la incertidumbre de la demanda. |
| **3. Calificación de Proveedores** | **Gestión de SCM (Supply Chain).** Toma de decisiones basada en KPIs ponderados.<br><br><img src="IMAGENES/Calificasion.png" alt="Dashboard Integral de Proveedores" width="300"> | Desarrollo de una **Matriz de Decisión Multicriterio** con dashboards interactivos (Mapas deAzure, Treemaps de distribución por calificación, KPI cards de promedio general [7.56]) que evalúan Precio, Calidad y Plazos mediante filtros dinámicos por estado y categoría. |
...
| **7. Creación Dash MACROS** | **Business Intelligence Dinámico.** Reporting autogestionable.<br><br><img src="IMAGENES/Dash.jpg" alt="Dashboard de Ventas Automatizado" width="300"> | Automatización mediante macros para la limpieza de datos (`ETL`) y construcción instantánea de dashboards de ventas con KPIs con iconos (GAP Ventas), gráficos de barras por categoría/vendedor y análisis temporal, incluyendo botones de control para limpiar y automatizar el reporte. |
| **8. Gráficos Dinámicos Auto23** | **Reporting de Alto Impacto.** Evita el mantenimiento manual de reportes.<br><br><img src="IMAGENES/Grafico dinamico.png" alt="Análisis Dinámico Real vs Proyectado" width="300"> | Uso de **Rangos Dinámicos** (Función `DESREF` o `TABLA`) y macros de actualización para que los gráficos de área crezcan automáticamente y analicen de forma interactiva los "Ingresos Reales vs Proyectados" a lo largo del tiempo según la selección del usuario. |
